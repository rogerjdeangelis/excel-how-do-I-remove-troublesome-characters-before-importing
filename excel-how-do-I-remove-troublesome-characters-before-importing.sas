...
I suggest remove the tabs on the excel side

see SAS forum
https://tinyurl.com/yboqkq4c
https://communities.sas.com/t5/New-SAS-User/How-do-I-remove-Tabs-from-data-Excel-file-is-unreadable/m-p/501154

MS-SQL command distionary on end
...
1  |   NAME              |   SEX      |    AGE     |  HEIGHT    |  WEIGHT    |
   +---------------------+------------+------------+------------+------------+
2  | '09'xAlfred'09'x    |    M       |    14      |    69      |  112.5     |
   +---------------------+------------+------------+------------+------------+
    ...
   +---------------------+------------+------------+------------+------------+
19 | '09'xWILLIAM'09'x   |    M       |    15      |   66.5     |  112       |
   +---------------------+------------+------------+------------+------------+
